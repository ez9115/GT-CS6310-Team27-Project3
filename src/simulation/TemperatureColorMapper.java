...
public class TemperatureColorMapper {
	private static TemperatureColorMapper instance = null;
	
	private TemperatureColorMapper() {	}
	
	static TemperatureColorMapper getInstance() {
		if(instance == null) {
			instance = new TemperatureColorMapper();
		}
		return instance;
	}
